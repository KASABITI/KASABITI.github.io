$(document).ready(function()
{
      ...
      $( ".timeline-content-left" ).animate({left: 20}, {duration: 900,
      step: function( now, fx ){
        $( ".timeline-content-left" ).slice( 1 ).css( "left", now );
       }
    });
    $( ".timeline-content-left-2" ).animate({left: 20}, {duration: 1400,
    step: function( now, fx ){
      $( ".timeline-content-left" ).slice( 1 ).css( "left", now );
     }
  });
    ...
    left: -23}, {duration: 700,
    step: function( now, fx ){
      $( ".timeline-content-left" ).slice( 1 ).css( "right", now );
    }
   });
     $( ".timeline-content-right-2" ).animate({left: -23}, {duration: 1200,
      step: function( now, fx ){
        $( ".timeline-content-left" ).slice( 1 ).css( "right", now );
       }
   });
